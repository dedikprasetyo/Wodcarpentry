...
<body class="bg-dark" style="padding-top: 100px;">
    <div class="sufee-login d-flex align-content-center flex-wrap">
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="#">
                        <img class="align-content" src="<?php echo base_url() ?>images/logoo2.png" height="25" width="25" alt="">
                    </a>
                </div>
                <div class="login-form">
                    <form action="<?php echo base_url('c0_profil/');?>">
